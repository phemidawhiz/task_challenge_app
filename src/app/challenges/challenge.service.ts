    ...
    return this.authService.user.pipe(
      ...
      switchMap(currentUser => {
        ...
        return this.http.get<{
          ...
          `https://task-challenge-app.firebaseio.com/challenge${currentUser.id}.json?auth=${currentUser.token}`
        );
      }),
      tap(resData => {
        if (resData) {
      ...
      .pipe(
        ...
        switchMap(currentUser => {
          ...
          return this.http.put(
            `https://ns-ng-course.firebaseio.com/challenge${currentUser.id}.json?auth=${
              currentUser.token
            }`,
            challenge
          );
